...
class AdminArticleController extends AdminBaseController
{
    ...
    public function delete()
    {
        ...
        if (isset($param['ids'])) {
            ...
            Db::startTrans();
            try {
                $portalPostModel->where(['id' => ['in', $ids]])->update(['delete_time' => time()]);
                ...
                //     c2c_recycle_bin('portal_post',$value['id'],$value['post_title']);
                // }
                Db::commit();
            } catch (\Exception $e) {
                Db::rollback();
