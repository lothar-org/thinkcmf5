...
/*资源扩充*/
     ...
     * @return number
     */
    public static function diff_day($time1='', $time2='')
    {
        $one = (empty($time1)) ? time() : (is_numeric($time1) ? $time1 : strtotime($time1));
        $two = (empty($time2)) ? time() : (is_numeric($time2) ? $time2 : strtotime($time2));
